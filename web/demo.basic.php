...
echo '<pre>' . $ThisFileInfo['filename'] . '</pre>';
echo '<pre>' . $ThisFileInfo['filepath'] . '</pre>';
echo '<pre>' . $ThisFileInfo['filesize'] . '</pre>';
echo '<pre>' . $ThisFileInfo['filenamepath'] . '</pre>';
echo '<pre>' . $ThisFileInfo['fileformat'] . '</pre>';
echo '<pre>' . $ThisFileInfo['mime_type'] . '</pre>';
